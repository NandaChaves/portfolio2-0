...
const handleSubmit = (e) => {
  ...
  return (
    <Section isContact={true}>
      ...
      <div className="mt-2 p-6 rounded-md bg-white w-96 max-w-full">
        <form ref={formRef} onSubmit={handleSubmit} method='POST'>
          ...
          <button  type="submit" disabled={loading} className="bg-indigo-600 text-white py-3 px-8 rounded-lg font-bold text-lg mt-4 submit">
